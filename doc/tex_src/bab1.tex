...
\end{enumerate}
    ...
    Sebagai tambahan, dalam tugas besar ini kami juga membuat tampilan antarmuka (\textit{graphical interface}, GUI) dan video penjelasan. 
    % Terakhir, sebagai aplikasi dari interpolasi \textit{bicubic spline}, kami juga akan mengimplementasikan \textit{image resizing and stretching}.
